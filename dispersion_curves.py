...
This script takes as input one or several binary files containing
cross-correlations previously calculated and exported (with module
pickle), and produces two file per set of cross-correlations:
